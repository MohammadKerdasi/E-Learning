...
export default function Error() {
  return (
    <div className="px-4 lg:px-20 desktop:px-40 h-full w-full max-w-2000 flex flex-col lg:flex-row justify-between items-center gap-7.5 py-10 lg:py-20 desktop:pt-25 desktop:pb-paddingBottom150">
