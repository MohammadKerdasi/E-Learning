...
export default function Error() {
  return (
    <div className="px-4 lg:px-20 desktop:px-40 h-full w-full flex flex-col lg:flex-row justify-start items-center gap-7.5 py-10 lg:py-20 desktop:pt-25 desktop:pb-paddingBottom150">
