...
export default function TopBanner({text1 , text2 , img1 , img2} : TopBanner) {
  return (
    <div className=" font-primary flex-wrap tablet:mt-5 mt-10 desktop:mx-7.5 tablet:mx-5 mx-4 h-min  justify-center items-center flex  text-white rounded-lg bg-Orange/50 py-3.5 md:px-4">
