...
const PricingSection = () => {
  ...
  return (
    <section>
      ...
      <div className="flex justify-between px-5-80 py-20 gap-7.5 bg-white rounded-xl max-1250:flex-wrap max-1250:justify-center max-desktop:py-12.5 max-sm:px-5 max-sm:py-7.5">
