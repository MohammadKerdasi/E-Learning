    ...
    <>
      ...
      >
        <div className="flex flex-col min-h-screen  ">
          <ul className="lg:hidden flex flex-col items-center justify-center gap-y-10 flex-grow">
          {navData.map((e, i) => (
            <li key={i}>
              <NavLink
                className={({ isActive }) =>
                  isActive
                    ? "py-3.5 px-6 rounded-lg font-normal text-white bg-Orange/50 h-full transition-all text-sm desktop:text-lg duration-300"
