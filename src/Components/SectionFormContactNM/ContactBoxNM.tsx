        ...
        <div>
            {boxes.map((box, index: number) => (
                <a href={box.href}
                    ...
                    bg-White/99 px-30px py-[29px] xl:py-[29.75px] 2xl:px-30px
                    2xl:py-[26.87px] text-sm xl:text-base 2xl:text-lg
                    leading-5.6 xl:leading-6 2xl:leading-27 text-Grey/30
                    mb-5 xl:mb-6 2xl:mb-paddingBottom50 text-center">
